...
func (s *messageService) GetMessageDetailUrl(msg *model.Message) string {
	if msg.Type == constants.MsgTypeTopicComment || msg.Type == constants.MsgTypeCommentReply {
	...
	} else if msg.Type == constants.MsgTypeTopicLike || msg.Type == constants.MsgTypeTopicFavorite ||
	...
	return urls.AbsUrl("/user/message")
}
