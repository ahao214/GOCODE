...
func GetCommentList(articleId int64, pageNum, pageSize int) (commmentList []*model.Comment, err error) {
	...
	sqlstr := `select 
						...
						limit ?, ?`
	err = DB.Select(&commmentList, sqlstr, articleId, pageNum, pageSize)
	return
}
